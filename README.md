...
C:\opt\kafka_2.13-3.7.1\           <i>(119 MB)</i>
...
We execute command [**`setenv.bat`**](setenv.bat) once to setup our development environment; it makes external tools such as [**`git.exe`**][git_userguide], [**`gradle.bat`**][gradle_cli] and [**`sh.exe`**][sh_cli] directly available from the Windows command prompt (see section [**Project dependencies**](#proj_deps)).
   ...
   <b>&gt; <a href="./setenv.bat">setenv</a> -verbose</b>
    Tool versions:
      ...
      gradle 8.8, kafka-configs 3.7.1, mvn 3.9.7,
    ...
    Tool paths:
      ...
      C:\opt\kafka_2.13-3.7.1\bin\windows\kafka-configs.bat
    ...
    Environment variables:
      ...
      "KAFKA_HOME=C:\opt\kafka_2.13-3.7.1"
...
<a href="https://kafka.apache.org/downloads">kafka_2.13-3.7.1.tgz</a>                               <i>( 82 MB)</i>
...
-->
[kafka_relnotes]: https://archive.apache.org/dist/kafka/3.7.1/RELEASE_NOTES.html
